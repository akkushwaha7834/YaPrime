          ...
          <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img class="d-block w-100" src="images/graphicdesignherobanner.png" alt="First slide" />
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="images/graphicdesignherobanner.png" alt="Second slide" />
              </div>
              <div class="carousel-item">
                <img class="d-block w-100" src="images/graphicdesignherobanner.png" alt="Third slide" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-12">
          <center>
            ...
            <div class="app_design_position">
              <img src="images/webdevicons.png" alt="appicons" width="100%" />
            </div>
          </center>
        </div>
      </div>
