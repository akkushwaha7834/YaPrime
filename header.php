          ...
          <ul class="navbar-nav mr-auto mb-2 mb-lg-0">
                  ...
                  <div class="container-fluid">
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-4 col-md-3 py-4">
                        <a class="newheaderyaprime" href="index.html">
                      ...
                      <div class="col-12 col-sm-4 col-md-3 py-4 row_positioning992">
                        ...
                        <div class="card">
                          <!-- <img
                            src="./images/yamarketssvgheader.svg"
                            class="img-fluid"
                            alt="image"
                          /> -->
                ...
                <div class="mega-content px-4">
                  <div class="container-fluid">
                    <div class="row">
                      ...
                      <div class="col-12 col-sm-4 col-md-3 py-4">
                        <h5 class="new-header-heading">Prime Special</h5>
                        <p class="new-header-paragraph-text row_positioning992">
                          Lorem ipsum dolo sit achmet muhamed borlan de irtka.
                        </p>
                      </div>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu shadow">
                <li>
                  <a class="dropdown-item yaprimeheader-size" href="#"
                    >Ya Wealth
                  </a>
                </li>
