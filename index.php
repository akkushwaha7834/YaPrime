   ...
   <!-- end of  unique feature -->
             ...
             <section class="reputed-section">
               <div class="container">
                    ...
                    <h1>Reputed for FX Expertise</h1>
                    <br>
  ...
  <section class="pricing_sec_light">
    <div class="container">
        ...
        <div class="col-md-12">
          <div class="text">
            <div class="pricing-plans-parent">
              ...
              <h1 class="check-our-Black">Reputed for FX Expertise</h1>
            </div>
            <br>
            <div class="experience-in-forex-container">
              <p class="experience-in-forex_light">Experience in forex industry can build real forex broker, we are</p>
              <p class="experience-in-forex_light">named for expertise, compare to know</p>
            </div>
          </div>
        </div>
      </div>
      <div class="row pricing_row_two">
        <div class="col-md-4">
          <div class="pricing_light">
            <div class="plans">
              <div class="plan">
                <div class="frame-group">
                  <div class="mt4-limited-parent">
                    <div class="mt4-limited_light">Prime VIP</div>
                    <div class="pricing_para_light">Lorem ipsum dolor sit amet consectetur. Augue consectetur nisl.
                    </div>
                  </div>
                  <div class="frame-container">
                    <div class="parent_light">
                      <div class="get-started-price">$1,899</div>
                      <div class="month">/month</div>
                    </div>
                    <a href="#" class="get-started">
                      <div class="button btton_bb">
                        Get started
                ...
                <div class="frame-parent1">
                  <div class="tick-parent">
                    ...
                    <div class="one-time-setup-container_light">
                  ...
                  <div class="tick-parent">
                    ...
                    <div class="one-time-setup-container_light">
                      ...
                      <span class="span">MT5 branded</span>
                    </div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick.svg">
                  ...
                  <div class="tick-parent">
                    ...
                    <div class="one-time-setup-container_light">Web API</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Forex CRM</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Wordpress website</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">MAM plugin</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Bonus plugin</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Extended dealer</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Multi-level IB</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Mobile manager</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Liquidity manager</div>
                  </div>
                  <div class="tick-parent">
                    <img class="tick-icon" alt="" src="images/tick-red.svg">

                    <div class="one-time-setup-container_light">Fix API manager</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="plans">
              <div class="plan1">
                <div class="frame-parent2">
                  <div class="mt4-limited-parent">
                    <div class="mt4-limited_light">Prime VVIP</div>
                    <div class="pricing_para_light">Lorem ipsum dolor sit amet consectetur. Augue consectetur nisl.
                    </div>
                  </div>
                  <div class="frame-container">
                ...
                <div class="div3">
                  <div class="recommended_light">Recommended</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="pricing_light">
            <div class="plans">
              <div class="plan">
                <div class="frame-group">
                  <div class="mt4-limited-parent">
                    <div class="mt4-limited_light">Prime Special</div>
                    <div class="pricing_para_light">Lorem ipsum dolor sit amet consectetur. Augue consectetur nisl.
                    </div>
                  </div>
                  <div class="frame-container">
