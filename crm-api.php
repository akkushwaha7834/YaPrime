...
<html lang="en">
  <head>
    ...
    <title>Top Web & Mobile App Development Services</title>
    <meta name="description" content="YaPrime delivers top web and mobile app development services, combining cutting-edge technology and innovative design for exceptional digital solutions."/>
    <meta name="keywords" content="top web development services, top mobile app development" />
...
<?php include 'includes/header.php';?>
  ...
  <!-- HEADER -->
  <!-- Banner Start-->
  <section class="crm_api_banner">
    <div class="container">
      <div class="row">
        <div class="col-md-12 crm_api_left">
          <h4 class="crm_h4">
            CRM & API
          </h4>
          <h1 class="crm_h1">
  ...
  <section class="what_crm">
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-6">
          <img src="images/illustrations.png" width="100%" class="admin_banner_image">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="mt4_white_lable_sec">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h4 class="crm_h4">
      ...
      <div class="row crm_row_two">
        <div class="col-md-6">
          <img src="images/crm_mt5.png" width="100%">
        </div>
        <div class="col-md-6 crm_content_right">
          <h4 class="crm_h4">
            Benefits
          </h4>
          <h1 class="crm_h1">
